...
Refer to this [Medusa Admin User Guide](https://docs.medusajs.com/user-guide/settings/locations-and-shipping/locations#manage-fulfillment-providers) to learn how to add a fulfillment provider to a location using the dashboard.
...
Fulfillment Module Providers registered in the Fulfillment Module's [options](https://docs.medusajs.com/commerce-modules/fulfillment/module-options) are stored and represented by the [FulfillmentProvider data model](https://docs.medusajs.com/references/fulfillment/models/FulfillmentProvider).
...
Refer to the [Create Fulfillment Module Provider](https://docs.medusajs.com/references/fulfillment/provider) guide to learn how to create a Fulfillment Module Provider.
...
Learn more about this option in the [Module Options](https://docs.medusajs.com/commerce-modules/fulfillment/module-options) guide.
...
A registered fulfillment provider is represented by the [FulfillmentProvider data model](https://docs.medusajs.com/references/fulfillment/models/FulfillmentProvider) in the Medusa application.
